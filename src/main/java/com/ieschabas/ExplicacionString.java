...
public class ExplicacionString {
    public static void main(String[] args){
        ...
        */
        ...
        //LLF 23TK LOP -> LLF-23TK-LOP
        String codigoConGuiones = codigo.replace ("","-");
       ...
       System.out.println("Introduce el nombre: ");
        ...
        String inicialNombre = nombreSinEspacios.substring(0,1);
        ...
        char inicialApelllido2  = apellidoSinEspacios.charAt (0);
        System.out.println("Bienvenido " + inicialNombre2 + "." + inicialApelllido2 + ".");

        //Parseo de la datos con split
        //Id;nombre;cantidad;precio
        String lineaProducto ="1;tomates;50;2";
        String[] productos = lineaProducto.split(";");
        Producto producto = new Producto();
        producto.setld(Long.parseLong(productos[0]));
